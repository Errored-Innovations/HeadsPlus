...
public class HPEntityDeathEvent extends HeadsPlusListener<EntityDeathEvent> {
    ...
    public void onEvent(EntityDeathEvent event) {
        ...
        if (event.getEntity().getKiller() != null && !hp.getConfiguration().getConfig().getStringList("plugin.mechanics.looting.ignored-entities").contains(event.getEntityType().name())) {
