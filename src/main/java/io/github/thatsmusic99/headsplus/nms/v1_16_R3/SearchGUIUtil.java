package io.github.thatsmusic99.headsplus.nms.v1_16_R3;
        ...
        public void e() {
            ...
            if(compat_mode) {
                try {
                    ...
                    Logger.getLogger(io.github.thatsmusic99.headsplus.nms.v1_16_R3.SearchGUIUtil.class.getName()).log(Level.SEVERE, "Anvil Error", ex);
                }
            } else {
